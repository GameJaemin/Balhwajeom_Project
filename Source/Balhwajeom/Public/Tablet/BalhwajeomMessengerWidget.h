...
private:
	...
	/** Optional image placed by hand in the WBP Designer (not generated by BuildMessenger()).
	 * If present, RefreshSelection() swaps its texture to the selected room's chat art. Name it
	 * exactly IMG_ChatBackground in the Designer for this binding to pick it up. */
	UPROPERTY(meta = (BindWidgetOptional))
